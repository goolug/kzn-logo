...
// opening recipe = the client-review settings: blue ink at 9% multiply over
// the 02-Home ground, full kaizen stack with calm slow fog
const DEFAULTS = {
  seed: 'kzn', scale: 1.31, kernel: 'fixed', duration: 750, stagger: 45,
  ink: '2E41E7', alpha: 0.09, blend: 'multiply', soft: 0, fuse: 0.3,
...
panel.append(
  el('div', { className: 'actions' }, undoBtn),
